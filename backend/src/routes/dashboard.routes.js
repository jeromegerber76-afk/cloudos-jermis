...
var newsValidation = [
    ...
    (0, express_validator_1.body)('publishNow')
        .optional()
        .isBoolean()
 ...
 */
router.post('/news', auth_middleware_1.requireAdminOrSupport, newsValidation, dashboardController.createNews);
/**
 ...
 * @access  Private
 */
router.get('/team-status', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var teamStatus, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, dashboardController.getTeamStatus()];
            case 1:
                teamStatus = _a.sent();
                res.json({
                    success: true,
